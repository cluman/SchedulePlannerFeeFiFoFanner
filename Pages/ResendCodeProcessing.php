...
{   echo "E-mail not registered, or already confirmed. Try <a href='index.php#Login'>login</a>."; exit(); }
...
{
	echo "Couldn't send confirmation code via e-mail. Please, try to <a href='index.php#ResendCode'>send your code again</a> later.<br>";
	exit();
}
